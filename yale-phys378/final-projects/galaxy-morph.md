# Building a Galaxy Morphology Classifier
...
3. While discussing your results, try to check if the accuracy of your classifer is dependant on some of the galaxy parameters referred to above. 
