...
3. While discussing your results, try to check if the accuracy of your radius prediction is dependant on some of the other galaxy parameters referred to above. 
